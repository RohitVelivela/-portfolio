...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "velivela.rohitkumar@gmail.com",
    href: "mailto:velivela.rohitkumar@gmail.com",
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/velivela-rohit-kumar-136357259/",
    content: "/velivela-rohit-kumar",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/RohitVelivela",
    content: "/Velivela-Rohit-Kumar",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Velivela Rohit Kumar</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Rohit Kumar, a Comp. Sci. Engineer with 1.5 year experience in Devlopment, DevOps and 
